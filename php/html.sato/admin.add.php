    ...
    <body>
        ...
        <!-- ボタン -->
            <form action="" method="get">
                ...
                <input type="button" onClick="location.href='http://192.168.24.50:8282/delete_item.php'"  value="削除"><br>
                ...
                if ($result = $db->query($sql)) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><input type="button" 
                                ...
                                <input type="button" 
                                            value="削除" 
                                            onclick="location.href=\'http://192.168.24.50:8282/delete_item.php\'">
                            </td>';
